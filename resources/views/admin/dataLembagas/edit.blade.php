...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.dataLembaga.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.data-lembagas.update", [$dataLembaga->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label for="nama_lembaga">{{ trans('cruds.dataLembaga.fields.nama_lembaga') }}</label>
                <input class="form-control {{ $errors->has('nama_lembaga') ? 'is-invalid' : '' }}" type="text" name="nama_lembaga" id="nama_lembaga" value="{{ old('nama_lembaga', $dataLembaga->nama_lembaga) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('singkatan') ? 'is-invalid' : '' }}" type="text" name="singkatan" id="singkatan" value="{{ old('singkatan', $dataLembaga->singkatan) }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('ketua') ? 'is-invalid' : '' }}" name="ketua_id" id="ketua_id">
                    @foreach($ketuas as $id => $entry)
                        <option value="{{ $id }}" {{ (old('ketua_id') ? old('ketua_id') : $dataLembaga->ketua->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
                @if($errors->has('ketua'))
                    <div class="invalid-feedback">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('sekretariat_wilayah') ? 'is-invalid' : '' }}" type="text" name="sekretariat_wilayah" id="sekretariat_wilayah" value="{{ old('sekretariat_wilayah', $dataLembaga->sekretariat_wilayah) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('website') ? 'is-invalid' : '' }}" type="text" name="website" id="website" value="{{ old('website', $dataLembaga->website) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('email') ? 'is-invalid' : '' }}" type="text" name="email" id="email" value="{{ old('email', $dataLembaga->email) }}">
                @if($errors->has('email'))
                    <div class="invalid-feedback">
                        {{ $errors->first('email') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('telp') ? 'is-invalid' : '' }}" type="text" name="telp" id="telp" value="{{ old('telp', $dataLembaga->telp) }}">
                @if($errors->has('telp'))
                    <div class="invalid-feedback">
                        {{ $errors->first('telp') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('whats_app') ? 'is-invalid' : '' }}" type="text" name="whats_app" id="whats_app" value="{{ old('whats_app', $dataLembaga->whats_app) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('lingkup_kegiatan') ? 'is-invalid' : '' }}" type="text" name="lingkup_kegiatan" id="lingkup_kegiatan" value="{{ old('lingkup_kegiatan', $dataLembaga->lingkup_kegiatan) }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('perizinan') ? 'is-invalid' : '' }}" name="perizinan_id" id="perizinan_id">
                    @foreach($perizinans as $id => $entry)
                        <option value="{{ $id }}" {{ (old('perizinan_id') ? old('perizinan_id') : $dataLembaga->perizinan->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('jumlah_anggota') ? 'is-invalid' : '' }}" type="number" name="jumlah_anggota" id="jumlah_anggota" value="{{ old('jumlah_anggota', $dataLembaga->jumlah_anggota) }}" step="1">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('provinsi') ? 'is-invalid' : '' }}" name="provinsi_id" id="provinsi_id">
                    @foreach($provinsis as $id => $entry)
                        <option value="{{ $id }}" {{ (old('provinsi_id') ? old('provinsi_id') : $dataLembaga->provinsi->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
