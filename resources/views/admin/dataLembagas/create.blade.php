...
@section('content')
    ...
    <div id="myDIV" style="display: none;" class="drop-shadow-lg">
        ...
        <div class="form-group">
            ...
            <input class="form-control {{ $errors->has('periode') ? 'is-invalid' : '' }}" type="text" name="periode"
                id="periode" value="{{ old('periode', '') }}">
    ...
    <div class="form-group">
        ...
        <input class="form-control {{ $errors->has('sekretariat_wilayah') ? 'is-invalid' : '' }}" type="text"
            name="sekretariat_wilayah" id="sekretariat_wilayah" value="{{ old('sekretariat_wilayah', '') }}">
    ...
    <div class="form-group">
        ...
        <input class="form-control {{ $errors->has('telp') ? 'is-invalid' : '' }}" type="text" name="telp"
    ...
    <div class="form-group">
        ...
        <input class="form-control {{ $errors->has('whats_app') ? 'is-invalid' : '' }}" type="text" name="whats_app"
            id="whats_app" value="{{ old('whats_app', '') }}">
    ...
    <div class="form-group">
        ...
        <select class="form-control select2 {{ $errors->has('perizinan') ? 'is-invalid' : '' }}" name="perizinan_id"
            id="perizinan_id">
    ...
    <div class="form-group">
        ...
        <input class="form-control {{ $errors->has('jumlah_anggota') ? 'is-invalid' : '' }}" type="number"
            name="jumlah_anggota" id="jumlah_anggota" value="{{ old('jumlah_anggota', '10') }}" step="1">
    ...
    <div class="form-group">
        ...
        <select class="form-control select2 {{ $errors->has('provinsi') ? 'is-invalid' : '' }}" name="provinsi_id"
            id="provinsi_id">
