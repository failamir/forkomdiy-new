...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.perizinan.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.perizinans.update", [$perizinan->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label for="instansi_penerbit">{{ trans('cruds.perizinan.fields.instansi_penerbit') }}</label>
                <input class="form-control {{ $errors->has('instansi_penerbit') ? 'is-invalid' : '' }}" type="text" name="instansi_penerbit" id="instansi_penerbit" value="{{ old('instansi_penerbit', $perizinan->instansi_penerbit) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nomor_izin') ? 'is-invalid' : '' }}" type="text" name="nomor_izin" id="nomor_izin" value="{{ old('nomor_izin', $perizinan->nomor_izin) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nama_izin') ? 'is-invalid' : '' }}" type="text" name="nama_izin" id="nama_izin" value="{{ old('nama_izin', $perizinan->nama_izin) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('tanggal_dikeluarkan') ? 'is-invalid' : '' }}" type="text" name="tanggal_dikeluarkan" id="tanggal_dikeluarkan" value="{{ old('tanggal_dikeluarkan', $perizinan->tanggal_dikeluarkan) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('berlaku_sampai') ? 'is-invalid' : '' }}" type="text" name="berlaku_sampai" id="berlaku_sampai" value="{{ old('berlaku_sampai', $perizinan->berlaku_sampai) }}">
