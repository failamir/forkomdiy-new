    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.villages.update", [$village->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('id_district') ? 'is-invalid' : '' }}" type="text" name="id_district" id="id_district" value="{{ old('id_district', $village->id_district) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('id_village') ? 'is-invalid' : '' }}" type="text" name="id_village" id="id_village" value="{{ old('id_village', $village->id_village) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('village_name') ? 'is-invalid' : '' }}" type="text" name="village_name" id="village_name" value="{{ old('village_name', $village->village_name) }}">
