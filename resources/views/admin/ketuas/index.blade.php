                ...
                <tbody>
                    @foreach($ketuas as $key => $ketua)
                        <tr data-entry-id="{{ $ketua->id }}">
                            ...
                            <td>
                                @can('ketua_show')
                                    <a class="btn btn-xs btn-primary" href="{{ route('admin.ketuas.show', $ketua->id) }}">
                                        {{ trans('global.view') }}
                                    </a>
                                @endcan

                                @can('ketua_edit')
                                    <a class="btn btn-xs btn-info" href="{{ route('admin.ketuas.edit', $ketua->id) }}">
                                        {{ trans('global.edit') }}
                                    </a>
                                @endcan

                                @can('ketua_delete')
                                    <form action="{{ route('admin.ketuas.destroy', $ketua->id) }}" method="POST" onsubmit="return confirm('{{ trans('global.areYouSure') }}');" style="display: inline-block;">
...
@can('ketua_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('admin.ketuas.massDestroy') }}",
