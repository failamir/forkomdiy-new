...
@can('data_cabang_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            ...
            @include('csvImport.modal', ['model' => 'DataCabang', 'route' => 'admin.data-cabangs.parseCsvImport'])
        </div>
    </div>
@endcan
<div class="card">
...
@endcan
  ...
  let table = $('.datatable-DataCabang:not(.ajaxTable)').DataTable({ buttons: dtButtons })
