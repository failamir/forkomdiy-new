...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.dataKerjaSama.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.data-kerja-samas.update", [$dataKerjaSama->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label for="nama_stakeholder">{{ trans('cruds.dataKerjaSama.fields.nama_stakeholder') }}</label>
                <input class="form-control {{ $errors->has('nama_stakeholder') ? 'is-invalid' : '' }}" type="text" name="nama_stakeholder" id="nama_stakeholder" value="{{ old('nama_stakeholder', $dataKerjaSama->nama_stakeholder) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('jangkauan_kerjasama') ? 'is-invalid' : '' }}" type="text" name="jangkauan_kerjasama" id="jangkauan_kerjasama" value="{{ old('jangkauan_kerjasama', $dataKerjaSama->jangkauan_kerjasama) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('jenis_kerjasama') ? 'is-invalid' : '' }}" type="text" name="jenis_kerjasama" id="jenis_kerjasama" value="{{ old('jenis_kerjasama', $dataKerjaSama->jenis_kerjasama) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('mulai_kerjasama') ? 'is-invalid' : '' }}" type="text" name="mulai_kerjasama" id="mulai_kerjasama" value="{{ old('mulai_kerjasama', $dataKerjaSama->mulai_kerjasama) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('frekuensi_kerjasama') ? 'is-invalid' : '' }}" type="text" name="frekuensi_kerjasama" id="frekuensi_kerjasama" value="{{ old('frekuensi_kerjasama', $dataKerjaSama->frekuensi_kerjasama) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('no_hp_wa_lembaga') ? 'is-invalid' : '' }}" type="text" name="no_hp_wa_lembaga" id="no_hp_wa_lembaga" value="{{ old('no_hp_wa_lembaga', $dataKerjaSama->no_hp_wa_lembaga) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('kontak_di_lembaga') ? 'is-invalid' : '' }}" type="text" name="kontak_di_lembaga" id="kontak_di_lembaga" value="{{ old('kontak_di_lembaga', $dataKerjaSama->kontak_di_lembaga) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('no_hp_wa_stakeholder') ? 'is-invalid' : '' }}" type="text" name="no_hp_wa_stakeholder" id="no_hp_wa_stakeholder" value="{{ old('no_hp_wa_stakeholder', $dataKerjaSama->no_hp_wa_stakeholder) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nama_lembaga_kerjasama') ? 'is-invalid' : '' }}" type="text" name="nama_lembaga_kerjasama" id="nama_lembaga_kerjasama" value="{{ old('nama_lembaga_kerjasama', $dataKerjaSama->nama_lembaga_kerjasama) }}">
