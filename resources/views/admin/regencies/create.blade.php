    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.regencies.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('id_province') ? 'is-invalid' : '' }}" type="text" name="id_province" id="id_province" value="{{ old('id_province', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('id_regency') ? 'is-invalid' : '' }}" type="text" name="id_regency" id="id_regency" value="{{ old('id_regency', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('regency_name') ? 'is-invalid' : '' }}" type="text" name="regency_name" id="regency_name" value="{{ old('regency_name', '') }}">
